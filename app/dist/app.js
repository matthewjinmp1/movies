...
renderTable = () => {
 ...
 if(state.view==='blocked'){ $('view-note').textContent='Blocked movies are hidden from other library views. Unblock to show them again. Current filters also apply here.'; $('empty').querySelector('strong').textContent=data.blockedCount?'No movies found':'No blocked movies'; }
